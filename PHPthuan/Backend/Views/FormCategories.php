...
<form style="margin: auto;width: 50%;" method="post" action="<?php echo $action ?>">
    <div class="form-group">
        ...
        <input style="width: 80%;" type="text" name="name" class="form-control" value="<?php echo isset($record->name)? $record->name:'';?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
    ...
    <div class="form-group">
        ...
        <select  style="width: 40%;" class="form-control" name="status" id="exampleFormControlSelect1">
