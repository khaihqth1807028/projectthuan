<div class="col-md-12">
    <div style="margin-bottom:5px;">
        <a href="index.php?controller=products&action=createParameter&product_id=<?php echo $product_id; ?>" class="btn btn-primary">Thêm thuộc tính sản phẩm: <?php $product = $this->getProduct($product_id);echo $product->name?></a>
    </div>
