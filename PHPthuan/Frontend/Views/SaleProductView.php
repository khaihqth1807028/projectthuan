                            ...
                            <div class="product-slide-entry">
                                <div class="product-image">
                                    ...
                                    <div class="bottom-line">
                                        <a class="bottom-line-a" href="index.php?controller=Cart&action=AddCart&id=<?php echo  $rows->id ?>&return=Sale"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                    </div>
                                </div>
